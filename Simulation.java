...
public class Simulation {
	public static void main(String[] args) {
		...
		System.out.println("Enter the number of time steps the model will be run:");
		int T = disease.getTimeSteps(scnr);
		System.out.println();
		
		//Infection rate rate
		System.out.println("Enter a number from 0 - 0.25 that will be the infection rate of an individual:");
		double alpha = disease.getInfectionRate(scnr);
		System.out.println();
		
		//Recovery rate
		System.out.println("Enter a number from 0 - 1 that will be the recovery rate of an individual:");
